...
description: 증상에서 근원까지의 인과 사슬을 재현 가능한 절차로 좁히는 체계적 디버깅 절차입니다.
declaration:
  asset_id: skill.debug-systematic
  asset_kind: skill
  version: 0.1.0
  platforms:
  - all
...
증상에서 근원까지의 인과 사슬을 재현 가능한 절차로 좁히는 체계적 디버깅 절차입니다.

## 소비 역할

`staff-engineer`, `frontend-developer`, `backend-developer`, `data-engineer`
