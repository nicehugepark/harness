---
name: tag-dup-search
description: 통제 어휘 태그 인덱스로 기존 기능·기결 사항을 검색하고 `dedup_check` 필드를 채우는 절차입니다.
declaration:
  asset_id: skill.tag-dup-search
  asset_kind: skill
  version: 0.1.0
  platforms:
  - all
...
통제 어휘 태그 인덱스로 기존 기능·기결 사항을 검색하고 `dedup_check` 필드를 채우는 절차입니다.
