...
description: 레이아웃 원칙·타이포그래피·색 체계를 결정하고 각 선택의 근거와 실렌더 증거를 기록하는 절차입니다.
declaration:
  asset_id: skill.frontend-design
  asset_kind: skill
  version: 0.1.0
  platforms:
  - all
...
레이아웃 원칙·타이포그래피·색 체계를 결정하고 각 선택의 근거와 실렌더 증거를 기록하는 절차입니다.
