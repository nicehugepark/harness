---
name: tdd
description: 설계의 테스트 시나리오에서 실패하는 테스트를 먼저 만들고, 그 실패 출력을 증거로 남긴 뒤 구현하는 절차입니다.
declaration:
  asset_id: skill.tdd
  asset_kind: skill
  version: 0.1.0
...
설계의 테스트 시나리오에서 실패하는 테스트를 먼저 만들고, 그 실패 출력을 증거로 남긴 뒤 구현하는 절차입니다.

## 소비 역할

`staff-engineer`, `frontend-developer`, `backend-developer`, `data-engineer`, `devops-engineer`, `security-engineer`
